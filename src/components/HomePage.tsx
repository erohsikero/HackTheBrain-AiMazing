...
import { Calendar, UserCheck, MessageCircle, Clock, Stethoscope, BarChart3, FileText, Brain, LogIn } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl shadow-lg p-6 text-white">
          <h3 className="text-lg font-semibold mb-4">Staff & Administrative Access</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button
              onClick={() => navigate('/staff-dashboard')}
              className="bg-white bg-opacity-10 hover:bg-opacity-20 border border-white border-opacity-20 px-4 py-3 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2"
            >
              <UserCheck className="w-5 h-5" />
              <span>Smart Waitlist Dashboard</span>
            </button>
            <button
            ...
            >
              ...
              <span>AI Impact Analytics</span>
            </button>
          </div>
        </div>

        {/* AI Features Highlight */}
        <div className="mt-8 bg-gradient-to-r from-blue-600 to-teal-600 rounded-2xl shadow-lg p-6 text-white text-center">
